...
XStream uses the GStreamer library to stream parts of X-Plane textures via an RTSP server.
This means you can display PFDs, ECAMs etc directly from your sim to another screen.

This project was inspired by [XTextureExtractor](https://github.com/waynepiekarski/XTextureExtractor)
but uses a standard RTSP stream and doesn't require a specific app or program to use. (And
I couldn't get it working on my Mac!)
